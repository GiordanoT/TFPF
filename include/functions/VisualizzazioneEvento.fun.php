...
function VisualizzazioneEvento($evento){
    $risultatoEvento = getData("SELECT e.approvato as approvato, e.sconto as sconto, e.id_categoria as e_idc, e.id as idevento, e.id_categoria as idcat, e.immagine as eveimmagine, c.immagine as catimmagine, e.nome as titolo, e.citta as citta, e.costo as prezzo,
